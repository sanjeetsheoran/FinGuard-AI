"""
FinGuard AI - Experiment 5

XGBoost Learning Rate / Estimator Trade-off

Experiment 3 (current champion):
    n_estimators = 500
    max_depth = 6
    learning_rate = 0.08
...
Purpose:
    Test whether more boosting rounds with a lower learning
    rate improve fraud detection performance.
...
def train_model(
    ...
    print(
        "\nExperiment 5 model training completed."
    )
...
def compare_with_experiment_3(
    experiment_5_metrics,
):

    section(
        "EXPERIMENT 3 VS EXPERIMENT 5"
    )
    ...
    exp5_pr_auc = float(
        experiment_5_metrics["pr_auc"]
    )

    print()

    if exp5_pr_auc > exp3_pr_auc:

        print(
            "Experiment 5 improved PR-AUC."
        )
    ...
    elif exp5_pr_auc < exp3_pr_auc:

        print(
            "Experiment 5 reduced PR-AUC."
        )
        ...
        print(
            "Experiment 5 produced the same PR-AUC."
        )
...
def save_artifacts(
    ...
    section(
        "SAVING EXPERIMENT 5 ARTIFACTS"
    )

    model_file = (
        MODEL_DIR
        / "xgboost_experiment_5.json"
    )
...
def main():
    ...
    section(
        "FinGuard AI - XGBoost Experiment 5"
    )
    ...
    print(
        "n_estimators increased from 500 to 700."
    )

    print(
        "learning_rate reduced from 0.08 to 0.05."
    )
