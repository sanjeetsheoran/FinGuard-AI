...
def evaluate_model(
    ...
    return {
        ...
        "train_rows": len(y_validation) * 0 + 413378,
...
def compare_with_experiment_2(
    experiment_3_metrics,
):
    ...
    if not EXP2_METRICS_FILE.exists():

        print(
            "Experiment 2 metrics file not found."
        )
    ...
    exp3_pr_auc = float(
        experiment_3_metrics["pr_auc"]
    )

    print()

    if exp3_pr_auc > exp2_pr_auc:

        print(
            "Experiment 3 improved PR-AUC."
        )
    ...
    elif exp3_pr_auc < exp2_pr_auc:

        print(
            "Experiment 3 reduced PR-AUC."
        )
        ...
        print(
            "Experiment 3 produced the same PR-AUC."
        )
...
def main():
    ...
    section(
        "FinGuard AI - XGBoost Experiment 3"
    )
    ...
    print(
        "Experiment 2 feature set retained."
    )

    print(
        "n_estimators increased from 300 to 500."
    )
